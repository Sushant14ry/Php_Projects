...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">NsTech</a></h1>
      ...
      <a href="AdminTheme/dash.php" class="get-started-btn scrollto">Get Started</a>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 d-flex mb-4 text-center align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
          ...
          <div class="col-xl-3 col-md-6 d-flex mb-4 text-center align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-tachometer"></i></div>
              <h4><a href="">Structural Analysis</a></h4>
              <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>
            </div>
          </div>

          <div class="col-xl-3 col-md-6 d-flex mb-4 text-center align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
          ...
          <div class="col-xl-3 col-md-6 d-flex mb-4 text-center align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
           ...
           <div class="col-xl-3 col-md-6 d-flex mb-4 text-center align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="">Photography And Event Management</a></h4>
              <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="member-info">
                ...
                <address>Address:- Dillibazar,Kathmandu</address>
                <p>Gmail:- niteshnick777@gmail.com</p>
                <p>Phone:- 9861288862</p>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="member-info">
                ...
                <address>Address:- Baneshwor,Kathmandu </address>
                <p>Gmail:- 321singhsunil@gmail.com</p>
                <p>Phone:- 9813172266</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
              ...
              <div class="member-info">
                <h4>Sushant Chaudhary</h4>
                <span>Senior Developer</span>
                <address>Address:- Kolvi-7, Bara</address>
                <p>Gmail:- csushant224@gmail.com</p>
                <p>Phone:- 9821224203</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="400">
              ...
              <div class="member-info">
                ...
                <address>Address:- Nepaltar,Kathmandu</address>
                <p>Gmail:- biplavnepal12@gmail.com</p>
                <p>Phone:- 9818108868</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Satungal,Kathmandu,44600</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>csushant224@gmail.com</p>
              </div>
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 shadow-lg p-3  bg-white" style="border-top: solid 3px #72aaeb; border-bottom: solid 3px #72aaeb;"><br>
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="name">Your Name</label>
                  <input type="text" name="fname" class="form-control" id="name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="mobile" class="form-control" id="mobile" data-rule="minlen:4" data-msg="Please enter 10 chars" />
                  <div class="validate"></div>
                </div>
                <div class="form-group col-md-6">
                  <label for="name">Subject</label>
                  <input type="text" class="form-control" name="subject" id="subject" data-rule="subject" data-msg="Please enter at least 8 chars of subject" />
                  <div class="validate"></div>
                </div>
              </div>
    ...
    <?php
      ...
      if(isset($_POST['save'])){
        ...
        $run_concat=mysqli_query($conn,$contact_us);
           ...
           ?>
              <script>
                alert('Your Quiry is Sent !!');
                window.location.href='nstech.php';
              </script>
          <?php
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Phone:</strong> +977 9821224203<br>
              <strong>Email:</strong> nstech7b@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Structural Analysis</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Audit and Estimating</a></li>
            </ul>
          </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>NsTech</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="#">Sushant Chaudhary</a>
      </div>
    </div>
  </footer><!-- End Footer -->
