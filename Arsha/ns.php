          ...
          <div class="row container">
            <div class="col m6 s12">
              <div class=" one" style="margin-top: 30%;" >
                ...
                <h2>We are The team of talanted designers making websites with Different Types of Frameworks</h2>
                <div class="d-lg-flex">
              ...
              <div class="col m3 s12">
                <div class="card hoverable">
                  ...
                  <div class="card-content">
                    <p><?php echo substr($ress['s_desc'],0,52) ?></p>
                  </div>
                ...
                <h5 class="white-text">NsTech</h5>
                 <?php
                     $i = 1;
                      ...
                      $show_setting="SELECT * FROM setting ";
                      $run_setting=mysqli_query($conn,$show_setting);
                        while($rows=mysqli_fetch_assoc($run_setting)){
                  ?>
                <p><b>Adress</b> : <span><?php echo $rows['o_address']  ?></span> </p>
                <p><b>Phone</b> :  <span><?php echo $rows['o_email']  ?></span> </p>
                <p><b>Email</b> :  <span><?php echo $rows['o_number']  ?></span> </p><br>
...
<!--                 <p><b>Adress</b> : <span>Dillibazar , Kathmandu, 44600</span> </p>
              ...
              <p>If You Want to Visit Our Social Site Then the Links are given below</p>
