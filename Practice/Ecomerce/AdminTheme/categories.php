         ...
         <div class="col-xl-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <h4 class="box-title btn btn-primary p-2"><a href="manage_categories.php" class="text-white">Add Categories</a></h4>
               </div>
               <div class="card-body--">
                              ...
                              <td>
                                 <?php 
                                    if($row['status'] == 1){
                                     ...
                                     echo "<span class='badge badge-delete btn btn-primary text-white'><a href='manage_categories.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
