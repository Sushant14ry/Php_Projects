<div id="sidebar" class="col-md-4">
    ...
    <div class="recent-post-container">
        ...
        $recent = "SELECT * FROM post order by 1 desc LIMIT 0,5";

        $result = mysqli_query($conn,$recent) or die("recent Query Failed");
        ...
        <div class="recent-post">
            ...
            <div class="post-content">
                ...
                <span>
                    ...
                    <a href='category.php?cid=<?php echo $rows['category'];  ?>'><?php echo $rows['category'] ?></a>
                </span>
                <span>
